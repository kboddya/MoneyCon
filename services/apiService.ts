...
import { API_ERROR_CODES, ApiError, createApiError } from "./apiErrors";
...
const getExchangeRatesFromApi = (
	...
	const stringDate = !diapason
		? "latest"
		: generateStringDate(addDays(new Date(), Math.min(diapason, -diapason)));
...
export type { CurrencyListResponse, ExchangeRatesResponse };
export { getCurrencyList, getExchangeRatesFromApi };
